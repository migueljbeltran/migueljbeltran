...
Full-stack game analytics platform for Deadlock (Valve's MOBA shooter) with an occult noir UI themed to the game's aesthetic.

- Built a full-stack game analytics platform with Next.js and PostgreSQL supporting real-time player search and match stat aggregation across thousands of records
- Designed normalized PostgreSQL schemas with composite indexes for efficient retrieval across thousands of player and match records without full-table scans
...
- Developed a Spring Boot REST API with MVC service layers for inventory, shopping list, and recipe management; batched queries eliminated redundant DB calls
...
- Designed and simulated a 5-stage pipelined 8-bit CPU with data forwarding and hazard-mitigation logic, achieving correct execution across 20+ custom ISA instructions
...
### [miguel-beltran.exe](https://migueljbeltran.github.io/)
